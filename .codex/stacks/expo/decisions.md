...
Korean note: Expo 기본 조합은 Expo Router, Expo Web 테스트 경로, TanStack Query, 필요 시 Zustand, React Hook Form, NativeWind 또는 StyleSheet, Font Awesome, 필요 시 React Native Paper이다.
